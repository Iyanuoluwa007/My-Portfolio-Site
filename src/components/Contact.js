...
const contactLinks = [
  ...
  {
    label: "Portfolio", value: "iyanuoluwaoke.vercel.app",
    href: "https://iyanuoluwaoke.vercel.app",
    icon: <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><path d="M2 12h20M12 2a15.3 15.3 0 010 20M12 2a15.3 15.3 0 000 20"/></svg>,
  },
];
    ...
    <section id="contact" style={{ position:"relative", padding:"96px 0", overflow:"hidden" }}>
      ...
      <div style={{ maxWidth:1152, margin:"0 auto", padding:"0 24px", position:"relative", zIndex:1 }}>
        ...
        <div className="contact-grid" style={{ display:"grid", gridTemplateColumns:"1fr 400px", gap:64, alignItems:"center" }}>
          ...
          {/* Left: CTA */}
          <div>
            <motion.span {...inView()} className="section-label" style={{ marginBottom:14 }}>06 — Contact</motion.span>
